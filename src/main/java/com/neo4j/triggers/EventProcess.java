...
public class EventProcess implements Runnable{
    ...
    public EventProcess (TransactionData transactionData, GraphDatabaseService graphDatabaseService, LogService logsvc) {
        td = transactionData;
        db = graphDatabaseService;
        log = logsvc.getUserLog(EventProcess.class);
    }
